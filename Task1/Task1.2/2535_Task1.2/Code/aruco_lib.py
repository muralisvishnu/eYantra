...
def detect_Aruco(img):  #returns the detected aruco list dictionary with id: corners
    ...
    aruco_dict = aruco.getPredefinedDictionary(aruco.DICT_4X4_1000)#aruco.Dictionary_get(aruco.DICT_4X4_50)   #creating aruco_dict with 5x5 bits with max 250 ids..so ids ranges from 0-249
    print(aruco_dict)
